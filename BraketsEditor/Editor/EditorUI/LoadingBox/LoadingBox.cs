...
namespace BraketsEditor.Editor
{
    public class LoadingBox : DebugWindow
    {
        ...
        public LoadingBox(string message)
            : base("Loading...", overridePos: true, overrideSize: true, visible: false, topmost: true,
        ...
        public void Draw(DebugWindow parent)
        {
            ...
            ImGui.ProgressBar(Value / 100, new Vector2(parent.Size.X - 20, 35), $"{Value:0}%");
